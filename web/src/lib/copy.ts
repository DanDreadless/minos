...
export const copy = {
  ...
  lists: {
    ...
    servicesHint: 'every service listed here is blocked for every device',
    servicesEmpty: 'No services blocked. Pick one below to block it everywhere.',
    servicePardonsEmpty: 'No services pardoned. Pick one below to always allow it.',
    servicePickerPlaceholder: 'Add a service…',
    servicePickerCatalog: 'Catalog',
    servicePickerYours: 'Yours',
    serviceRemoveTitle: (label: string) => `remove ${label} from this list`,
    servicesNote:
    ...
    customManageBlockHint: 'define your own bundle of domains and block it like any service',
    customManagePardonHint: 'define your own bundle of domains and pardon it like any service',
    ...
    customSharedNote:
      'Custom services are shared: the same bundle can be blocked here, pardoned on the other page, and used by groups.',
    customConfirmDelete: (label: string) =>
      `Remove the custom service "${label}"? Any blocks or pardons using it — here, on the other page, or in groups — stop applying immediately.`,
  },
  ...
  devices: {
    ...
    groupServicesEmpty: 'Nothing blocked for this group yet. Pick a service below.',
    groupAllowedServices: 'Service pardons for this group',
    groupAllowedServicesEmpty: 'Nothing pardoned for this group yet. Pick a service below.',
